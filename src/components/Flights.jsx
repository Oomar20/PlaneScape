                    ...
                    <div className="bg-white p-6 rounded-lg shadow-lg mb-6 relative" >
                        <div className="flex justify-between items-center">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-sm text-gray-500">{activeButton === 'roundTrip' ? 'Round Trip' : 'One Way'}</p>
                            </div>
                                    ...
                                    onClick={() => {
                                        if (departureFlights.length > 0) {
                                            const flightData = {
                                                ...
                                                icao_code: departureFlights[0].prefixICAO,
                                    ...
                                    <button
                                        ...
                                        onClick={() => {
                                            const flightData = {
                                                ...
                                                icao_code: returnFlights[0].prefixICAO,
                                                departureAirport: departureAirport,
                                                arrivalAirport: returnAirport,
                                                scheduleTime: departureFlights[0].scheduleTime,
                                            ...
                                            onBookFlight(flightData);  // Sending flight data to handleBookFlight function
                                        }}
                                    >
                                        Book Flight
                                    </button>
